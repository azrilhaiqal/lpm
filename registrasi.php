...
?>
    ...
    <div class="slider_area2">
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2" style="background-image: url('img/banner/dedi-picsay.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
             <div class="slider_text ">
                                <center><h1 style="color:white"> Pengaduan Masyarakat<br></h1>
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa Batujajar Barat<br>
                                    Silahkan Registrasi dan Login dengan akun anda.</p></p>
